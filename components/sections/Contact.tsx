...
const ContactPage = () => {
    return (
        <div
            className="relative bg-zinc-950 min-h-screen flex items-center justify-center py-20"
            id="contact"
        >
            {/* Solid background overlay to cover any grid effects */}
            <div className="absolute inset-0 bg-zinc-950 z-0" />

            <div className="relative w-full max-w-6xl mx-auto px-4 py-20 z-10">
                {/* Header */}
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <motion.div
                        ...
                        className="bg-zinc-900/50 p-8 rounded-2xl"
                    >
