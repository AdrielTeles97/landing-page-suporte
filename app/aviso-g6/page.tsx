...
export default function AvisoG6() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 py-20 px-4">
            <div className="max-w-4xl mx-auto">
                    ...
                    <div className="p-8 md:p-12">
                        ...
                        <div className="bg-red-50 border-l-4 border-red-600 p-6 mb-8 rounded-r-lg">
                            ...
                            <p className="text-red-800 text-lg leading-relaxed">
                                ...
                                atualizações desde{' '}
                                <strong>agosto de 2021</strong> e foi
                                oficialmente descontinuado.
                            </p>
                        </div>

                        {/* Informação de Data */}
                        <div className="flex items-start gap-4 mb-8 bg-yellow-50 p-6 rounded-lg">
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-8 rounded-xl mb-8 border border-blue-200">
                            ...
                            <p className="text-blue-800 text-lg leading-relaxed mb-4">
                                É <strong>essencial</strong> que você atualize
                                seu sistema imediatamente para continuar
                                operando com segurança e conformidade.
                            </p>
                            <p className="text-blue-800 text-lg leading-relaxed">
                                O valor da migração{' '}
                                <strong>varia de acordo com a versão</strong>{' '}
                                atual do seu sistema e necessidades específicas.
                            </p>
                        </div>
                ...
                <div className="mt-8 text-center text-gray-600">
                    <p className="text-sm">
                        Bel Informática - Suporte e Soluções em Automação
                        Comercial
                    </p>
                </div>
            </div>
