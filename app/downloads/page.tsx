    ...
    const downloads = [
        {
            ...
            items: [
                {
                    name: 'AnyDesk',
                    description: 'Controle remoto rápido e seguro',
                    version: 'Latest',
                    size: '5.5 MB',
        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    description:
                        'Versão atual da aplicação para envio de arquivos XMLs suporte Bel Informática',
                    version: '1.0.0',
                    size: '22.734 MB',
                ...
                },
                {
                    ...
                    description:
                        'Utilize para tentar reconher e instalar certificado A3',
                    version: 'JAN 2025',
                    size: '825 KB',
            ...
            <div className="max-w-6xl mx-auto px-4 py-20">
                ...
                >
                    ...
                    <p className="text-white/60">
                        Precisa de ajuda com a instalação? Entre em contato com
                        nosso suporte:
                    </p>
                    <Link
                        href="/contato"
